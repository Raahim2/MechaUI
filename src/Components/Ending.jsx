...
export function Ending() {
  ...
  return (
    <>
        <div
      className="invert h-[400vh] bg-black w-full dark:border dark:border-white/[0.1] rounded-md relative pt-40 overflow-clip"
      ref={ref}>
      <Effect
        pathLengths={[
          pathLengthFirst,
